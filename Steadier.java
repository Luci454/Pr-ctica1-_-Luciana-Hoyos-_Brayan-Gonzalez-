...
public class Steadier extends PitCrewTeam implements TeamDriverB{
    //Propierties
    private int energy = 100;

    //Constructor
    public Steadier(String name, String rolName, String timeIntoTheCrew, char Boss){
        super(name, rolName, timeIntoTheCrew, Boss);
    }
    public Steadier(PitCrewTeam Member){
    ...
    private int SteadierAction(){
        int complete = 0;
        if (energy > 0){
            this.energy = energy-30;
            System.out.println("\nThe Steadier lift the car into the air from the rear and operate the side jack.");
            complete = 1;
        }else{
